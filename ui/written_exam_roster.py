...
def written_exam_roster(content):
    ...
    # 匯出按鈕
    export_btn(written_exam_roster, text='匯出 筆試清冊 文件', command=lambda: export_written_exam_roster(database_path, get_all_added_student_ids())).grid(row=7, column=3, sticky='wen', padx=10)