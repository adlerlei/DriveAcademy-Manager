...
def student_all(content):
    ...
    # 信箱
    label(student_all, text='信箱').grid(row=4, column=2, sticky='ws', padx=(10,0))
    ...
    # 學歷
    label(student_all, text='學歷').grid(row=8, column=2, sticky='ws', padx=(10,0), pady=(10,0))
    combobox(student_all, values=['國中', '高中', '大學']).grid(row=9, column=2, columnspan=2, sticky='wen', padx=10)
