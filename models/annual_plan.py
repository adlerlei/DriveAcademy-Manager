...
def insert_annual_plan_data(year, term, batch, training_type_code, training_type_name, start_date, end_date):
    ...
    # 新增期別新增資料
    c.execute("INSERT INTO annual_plan (year, term, batch, training_type_code, training_type_name, start_date, end_date) VALUES (?,?,?,?,?,?,?)", (year, term, batch, training_type_code, training_type_name, start_date, end_date))
